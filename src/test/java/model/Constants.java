...
public class Constants {
    ...
    public static final String CODE_LESS_THAN_LIMIT_VALIDATION_MESSAGE = "The code must be at least 2 characters.";
    public static final String CODE_MORE_THAN_LIMIT_VALIDATION_MESSAGE = "The code may not be greater than 10 " +
            "characters.";
}
